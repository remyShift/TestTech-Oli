export const productAccordionData = [
    ...
    },
    {
        ...
        <div className="font-space-grotesk text-sm text-ceramics leading-relaxed">
            ...
            <li>Niacinamide (4%) - Améliore la texture de la peau</li>
            <li>Acide hyaluronique - Hydratation intense</li>
            <li>Vitamine E - Protection contre les radicaux libres</li>
            </ul>
    ...
    },
    {
        ...
        <div className="font-space-grotesk text-sm text-ceramics leading-relaxed">
            ...
            <li>Peaux avec des pores dilatés</li>
            <li>Peaux ternes manquant d'éclat</li>
            <li>Peaux sensibles (testé dermatologiquement)</li>
            </ul>
